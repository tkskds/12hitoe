<?php
  ...
  $sec1anime    = get_option('site_feature_section_animation')          ? get_option('site_feature_section_animation')  : 'value9' ;
  ...
  $sec2anime    = get_option('site_feature_section2_animation')         ? get_option('site_feature_section2_animation') : 'value9' ;
  ...
  $sec3anime    = get_option('site_feature_section3_animation')         ? get_option('site_feature_section3_animation') : 'value9' ;
  ...
  $sec4anime    = get_option('site_feature_section4_animation')         ? get_option('site_feature_section4_animation') : 'value9' ;
  ...
  $sec5anime    = get_option('site_feature_section5_animation')         ? get_option('site_feature_section5_animation') : 'value9' ;
  $sec5info     = get_option('site_feature_section5_info');
  $sec5map      = get_option('site_feature_section5_map');
  $sec6anime    = get_option('site_feature_section6_animation')         ? get_option('site_feature_section6_animation') : 'value9' ;
...
<div class="features">
  ...
  <section id="feature1"<?php addAnimeClass($sec1anime); ?>>
    <div class="container featureContainer">
      <div class="f_ttl"<?php if($sec1anime != 'value9') echo $anmHook ?>>
        <h2><?php echo $title ?></h2>
        <p><?php echo $description ?></p>
      </div>
      <?php if($item1Ttl != null || $item1Dsc != null): ?>
      <div class="f_items"<?php if($sec1anime != 'value9') echo $anmHook ?>>
        <div class="f_item">
        ...
        <?php if($item2Ttl != null || $item2Dsc != null): ?>
          <div class="f_item"<?php if($sec1anime != 'value9') echo $anmHook ?>>
  ...
  <section id="feature2"<?php addAnimeClass($sec2anime); ?>>
    <div class="container featureContainer">
      <?php if($sec2ttl!=null): ?>
        <h2<?php if($sec2anime != 'value9') echo $anmHook ?>><?php echo $sec2ttl ?></h2>
      <?php endif; ?>
      <?php if($sec2dsc!=null): ?>
        <p<?php if($sec2anime != 'value9') echo $anmHook ?>><?php echo $sec2dsc ?></p>
      <?php endif; ?>
    </div>
  </section>
<?php endif; //END sec2 ?>
  ...
  <section id="feature3"<?php addAnimeClass($sec3anime); ?>>
    <div class="container featureContainer">
      <?php if($sec3ttl!=null): ?>
        <h2<?php if($sec3anime != 'value9') echo $anmHook ?>><?php echo $sec3ttl ?></h2>
      <?php endif; //END sec3ttl ?>
      <?php if($sec3dsc!=null): ?>
        <p<?php if($sec3anime != 'value9') echo $anmHook ?>><?php echo $sec3dsc ?></p>
...
<?php endif; //END sec3 ?>
  ...
  <?php if($sec4q1 != null): ?>
    <section id="feature4"<?php addAnimeClass($sec4anime); ?>>
      <div class="container featureContainer">
        <h2>よくある質問</h2>
        <ul class="collapsible"<?php if($sec4anime != 'value9') echo $anmHook ?>>
            <li>
  ...
  <?php if($sec5info != null || $sec5map != null): ?>
    <section id="feature5"<?php addAnimeClass($sec5anime); ?>>
      ...
      <?php if($sec5info != null): ?>
        <div<?php if($sec5anime != 'value9') echo $anmHook ?>>
          <h2>INFO</h2>
          <?php echo $sec5info ?>
        </div>
      <?php endif; ?>
      <?php if($sec5map != null): ?>
        <div class="feature_map"<?php if($sec5anime != 'value9') echo $anmHook ?>>
        <h2>MAP</h2>
          <?php echo $sec5map ?>
        </div>
      <?php endif; ?>
