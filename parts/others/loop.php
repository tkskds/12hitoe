  ...
  <a href="<?php the_permalink(); ?>">
    <div class="thumbnail">
      ...
      <?php if (has_post_thumbnail()): ?>
        <?php the_post_thumbnail('medium', array('alt' => $ttl)); ?>
      <?php else: ?>
        <img src="<?php echo get_template_directory_uri(); ?>/images/default_thumbnail.png" alt="<?php echo $ttl ?>" width="300" height="180">
      <?php endif; ?>
    </div>
    <div class="content">
