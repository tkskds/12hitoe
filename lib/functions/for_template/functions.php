...
function add_heading_class($content){
  ...
  $h3class   = get_option('site_decoration_h3_type') ? get_option('site_decoration_h3_type') : 'type2';
  $h4class   = get_option('site_decoration_h4_type') ? get_option('site_decoration_h4_type') : 'type3';
